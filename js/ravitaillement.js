...
// [FIX STOCK-CAISSIER] Le ravitaillement augmente le stock : réservé
// au gérant/propriétaire. Garde-fou côté client (voir aussi
// _bloquerSiCaissier dans catalogue.js) — les boutons sont en plus
// masqués pour le caissier dans _applyRoleRestrictions (shop.js).
function _ravBloquerSiCaissier() {
...
window.ouvrirModalRavitaillement = function ouvrirModalRavitaillement() {
  if (_ravBloquerSiCaissier()) return;
